...
// prettier-ignore
const styles = {
    transactionAccount: 'transaction-account drt:flex drt:items-center drt:gap-2',
    transactionAccountExplorerLink: 'transaction-account-explorer-link drt:text-primary!'
