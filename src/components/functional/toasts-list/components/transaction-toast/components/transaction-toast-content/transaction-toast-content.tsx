...
// prettier-ignore
const styles = {
  transactionToastClose: 'transaction-toast-close drt:flex drt:flex-col drt:justify-center drt:shrink-0 drt:cursor-pointer drt:text-primary'
          ...
          <div class="transaction-toast-details">
            <div class="transaction-toast-details-header">
              <div class="transaction-toast-header-left">
                ...
                {showTooltip && (
                  <drt-tooltip position="bottom" trigger={<drt-circle-info-icon />}>
                    {amount.label}
                  </drt-tooltip>
                )}
              </div>
