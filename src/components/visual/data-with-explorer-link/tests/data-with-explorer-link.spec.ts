...
describe('DataWithExplorerLink', () => {
  ...
  it('renders with custom class and data-testid', async () => {
    const page = await newSpecPage({
      components: [DataWithExplorerLink, Trim, CopyButton, ExplorerLink],
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" class="custom-class" data-testid="custom-test-id"></drt-data-with-explorer-link>',
    });
  ...
  it('has correct component properties set', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" show-copy-button="false" show-explorer-button="true" with-tooltip="true" class="custom" data-testid="test"></drt-data-with-explorer-link>',
    });
