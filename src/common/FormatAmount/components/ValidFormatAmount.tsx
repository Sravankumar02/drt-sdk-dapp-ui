...
// prettier-ignore
const styles = {
    formatAmount: 'format-amount drt:items-center',
    intAmount: 'int-amount drt:text-inherit',
    decimals: 'decimals drt:text-inherit',
    symbol: 'symbol drt:text-inherit drt:ml-1'
